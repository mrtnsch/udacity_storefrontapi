...
var saltRounds = parseInt(SALT_ROUNDS);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, bcrypt_1["default"].hash(u.password + pepper, saltRounds)];
                    case 2:
                        hash = _a.sent();
                        return [4 /*yield*/, conn
                    ...
                    case 4:
                        err_1 = _a.sent();
                        throw new Error("Failed to create new user ".concat(u.firstname, " ").concat(u.lastname, ". Error: ").concat(err_1));
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 5:
                        err_2 = _a.sent();
                        throw new Error("Failed to authenthicate. Error: ".concat(err_2));
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_3 = _a.sent();
                        throw new Error("Failed to retrieve users. Error: ".concat(err_3));
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        conn = _a.sent();
                        sql = 'SELECT firstname, lastname, id FROM users WHERE id=($1)';
                    ...
                    case 3:
                        err_4 = _a.sent();
                        throw new Error("Failed to retrieve user with id ".concat(id, ". Error: ").concat(err_4));
                    case 4: return [2 /*return*/];
                }
            });
        });
